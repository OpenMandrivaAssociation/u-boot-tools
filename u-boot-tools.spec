...
Source0:	u-boot-2011.09.tar.bz2
Patch0:		0001-Build-timestamp_autogenerated.h-without-config.patch
Patch1:		0002-Safer-timestamp_autogenerated.h-generation.patch
Patch2:		0003-ublimage-NAND-block-size-isn-t-set-at-build-time.patch
